...
| `spikes/s7_mumu/work/g5_best_strip.png` (전체) / `click_coord_area.png` (전체) | 좌표 줄은 `harvest_glyphs.py`(s7)가 자동 정렬 | `(350,306)` / `(346,313)` — **MuMu 렌더링**(DCR-005). `3`→`8` 2건·`)`→`0` 1건 오판독 → `3_2`·`3_3`·`paren_r_4` 수확, PC 회귀 11소스 무잠식 검증 |
